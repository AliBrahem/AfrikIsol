 ...
 */
class Planification extends \BackOffice\AdminBundle\Entity\Planification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'quantite', 'idprojet');
    }
