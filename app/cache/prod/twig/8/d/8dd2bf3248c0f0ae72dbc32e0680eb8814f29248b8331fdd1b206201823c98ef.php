...
class __TwigTemplate_8dd2bf3248c0f0ae72dbc32e0680eb8814f29248b8331fdd1b206201823c98ef extends Twig_Template
{
    ...
    public function block_user_content($context, array $blocks = array())
    {
        ...
        echo " method=\"POST\">
            ...
            <table id=\"example2\" class=\"table table-bordered table-hover\">
                <tr>
                    ...
                    <td>";
        // line 13
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "societe", array()), 'widget');
        echo "</td>
                    </tr>
                    <tr>
        ...
        echo "</td>
                    ...
                    <td>";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "secteurActivite", array()), 'widget');
        echo "</td>
                    </tr>
                    <tr>
        ...
        echo "</td>
                    ...
                    <td>";
        // line 29
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "mail", array()), 'widget');
        echo "</td>
                    </tr>
                    <tr>
                    ...
                    <td>";
        // line 33
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "telecopie", array()), 'widget');
        echo "</td>
                    </tr>
                    <tr>
                    ...
                    <td>";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "titreContact", array()), 'widget');
        echo "</td>
                    </tr>
                    <tr>
