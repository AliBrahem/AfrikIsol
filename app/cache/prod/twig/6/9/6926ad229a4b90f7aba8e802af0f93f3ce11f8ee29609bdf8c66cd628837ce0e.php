 ...
 \$(function () {
    ...
    \$('#container').highcharts({
        ...
        series: [
        {
            ...
            ";
        // line 52
        if ((isset($context["avanc"]) ? $context["avanc"] : null)) {
            echo "  
             ";
            // line 53
            $context["var"] = 0;
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["avanc"]) ? $context["avanc"] : null));
            $context['loop'] = array(
            ...
            ";
                // line 56
                $context["var"] = ((isset($context["var"]) ? $context["var"] : null) + $this->getAttribute($context["Avanc"], "quantite", array()));
                // line 57
                echo "                             ";
                if ( !$this->getAttribute($context["loop"], "last", array())) {
                    ...
                    echo "/";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["projet"]) ? $context["projet"] : null), "quantite", array()), "html", null, true);
                    echo ")*100],
                         ";
                } else {
                    // line 59
        ...
        echo "        }
         ,{
            ...
            ";
        // line 68
        if ((isset($context["mad"]) ? $context["mad"] : null)) {
            // line 69
            echo "             ";
            $context["var2"] = 0;
            // line 70
            echo "            ,data: [";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["mad"]) ? $context["mad"] : null));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Mad"]) {
                // line 71
                echo "                ";
                $context["var2"] = ((isset($context["var2"]) ? $context["var2"] : null) + $this->getAttribute($context["Mad"], "quantite", array()));
                // line 72
                echo "                             ";
                if ( !$this->getAttribute($context["loop"], "last", array())) {
                    // line 73
                    ...
                    echo "\"),(";
                    echo twig_escape_filter($this->env, (isset($context["var2"]) ? $context["var2"] : null), "html", null, true);
                    echo "/";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["projet"]) ? $context["projet"] : null), "quantite", array()), "html", null, true);
                    echo ")*100],
                         ";
       ...
       , {
        ...
        if ((isset($context["plan"]) ? $context["plan"] : null)) {
            ...
            echo "            ,data: [";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["plan"]) ? $context["plan"] : null));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Plan"]) {
                // line 85
                echo "                ";
                $context["var3"] = ((isset($context["var3"]) ? $context["var3"] : null) + $this->getAttribute($context["Plan"], "quantite", array()));
                // line 86
                echo "                             ";
                if ( !$this->getAttribute($context["loop"], "last", array())) {
                    // line 87
                    ...
                    echo "\"),(";
                    echo twig_escape_filter($this->env, (isset($context["var3"]) ? $context["var3"] : null), "html", null, true);
                    echo "/";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["projet"]) ? $context["projet"] : null), "quantite", array()), "html", null, true);
                    echo ")*100],
                         ";
