...
class __TwigTemplate_ef572e03e3b837a9e3929855b719cf84e53e667b1a471c2604df2e54be40ade7 extends Twig_Template
{
    ...
    public function block_user_content($context, array $blocks = array())
    {
        ...
        <form action=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tech_addGantt", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "html", null, true);
        echo "\"  method=\"POST\">
             <h1> Planification </h1>
             <br>
