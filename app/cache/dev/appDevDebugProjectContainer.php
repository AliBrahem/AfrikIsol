...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'AfriqueIsolDB', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6064924f5ab77a1dddfef07ad637852b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6064924f5ab77a1dddfef07ad637852b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6064924f5ab77a1dddfef07ad637852b');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\BackOffice\\AdminBundle\\Entity'))), 'BackOffice\\AdminBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('AdminBundle' => 'BackOffice\\AdminBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('BackOffice\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('BackOffice\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('BackOffice\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('BackOffice\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'BackOffice\\AdminBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \BackOffice\AdminBundle\Redirection\AfterLoginRedirection A BackOffice\AdminBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \BackOffice\AdminBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\BackOffice\\AdminBundle/Resources/views'), 'Admin');
    ...
    {
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter(new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_TECHNIQUE' => array(0 => 'ROLE_T'), 'ROLE_COMMERCIAL' => array(0 => 'ROLE_C'), 'ROLE_LOGISTIQUE' => array(0 => 'ROLE_L'), 'ROLE_FINANCIER' => array(0 => 'ROLE_F'), 'ROLE_ADMIN' => array(0 => 'ROLE_A')))), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($this->get('security.authentication.trust_resolver'))), 'affirmative', false, true);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdminBundle' => 'BackOffice\\AdminBundle\\AdminBundle',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_TECHNIQUE' => array(
                    0 => 'ROLE_T',
                ),
                'ROLE_COMMERCIAL' => array(
                    0 => 'ROLE_C',
                ),
                'ROLE_LOGISTIQUE' => array(
                    0 => 'ROLE_L',
                ),
                'ROLE_FINANCIER' => array(
                    0 => 'ROLE_F',
                ),
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_A',
            ...
            'fos_user.model.user.class' => 'BackOffice\\AdminBundle\\Entity\\User',
