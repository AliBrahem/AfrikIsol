 ...
 */
class Stock extends \BackOffice\AdminBundle\Entity\Stock implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'designation', 'unite', 'nature', 'qteStock');
    }
