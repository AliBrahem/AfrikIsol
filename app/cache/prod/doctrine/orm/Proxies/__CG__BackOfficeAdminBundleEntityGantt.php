 ...
 */
class Gantt extends \BackOffice\AdminBundle\Entity\Gantt implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'item', 'dateDebut', 'dateFin', 'idprojet');
    }
